...
urlpatterns = [
    ...
    path(
        "tickets/detail/vpn/<int:ticket_id>/",
        views.tickets_detail_vpn,
        name="tickets_detail_vpn",
    ),
    path(
        "tickets/detail/repairs/<int:ticket_id>/",
        views.tickets_detail_repairs,
        name="tickets_detail_repairs",
    ),
    path(
        "tickets/detail/report/<int:ticket_id>/",
        views.tickets_detail_report,
        name="tickets_detail_report",
    ),
    path(
        "tickets/detail/app/<int:ticket_id>/",
        views.tickets_detail_newapp,
        name="tickets_detail_newapp",
    ),
    path(
        "tickets/detail/promotion/<int:ticket_id>/",
        views.active_promotion_detail,
        name="active_promotion_detail",
    ),
    ...
    path(
        ...
        views.active_promotion_form,
        name="active_promotion_form",
    ),
    ...
    path(
        ...
        views.team_removeuser,
        name="team_removeuser",
    ),
    # ===== TEAM SETUP =====
    path("settingline/", views.setting_team, name="setting_team"),
    path("team/<int:team_id>/add-user/", views.team_adduser, name="team_adduser"),
